...
import com.android.adapter.CommunityBlockOtherAdapter;
...
import com.android.model.CommunityBlockOtherBean;
 ...
 */
public class CommunityBlockOtherActivity extends BaseAppCompatActivity implements View.OnClickListener ,
    ...
    List<CommunityBlockOtherBean> list;
    List<CommunityBlockOtherBean> listTemp = new ArrayList<>();
    CommunityBlockOtherAdapter adapter;
    ...
    public void initData() {
        ...
        list = new ArrayList<>();
        adapter = new CommunityBlockOtherAdapter(this,list);
    ...
    public void setListener() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                intent.putExtra("buildname",name);
    ...
    private void getData() {
        ...
        HttpUtil.get(Constants.HOST + Constants.OtherBlock, params, new AsyncHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
                if(!NetUtil.checkNetInfo(CommunityBlockOtherActivity.this)){
                    ...
                    try {
                        ...
                        if (jsonObject != null) {
                            ...
                            if (jsonObject.getBoolean("success")) {
                                ...
                                listTemp = JSON.parseArray(gg.getJSONArray("items").toString(), CommunityBlockOtherBean.class);
